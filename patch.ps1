$content = Get-Content 'app/src/main/java/com/lalit/kakeibox/ui/theme/KakeiboXApp.kt' -Raw -Encoding UTF8

$pattern = '(?s)                    if \(themeSettings\.navBarStyle == NavBarStyle\.FULL_WIDTH\) \{.*?(?=                    if \(themeSettings\.navBarStyle == NavBarStyle\.SPLIT\) \{)'
...
$new_content | Set-Content 'app/src/main/java/com/lalit/kakeibox/ui/theme/KakeiboXApp.kt' -Encoding UTF8
